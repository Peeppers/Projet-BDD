<?php	
  ...
  `mdpAbonne`, `id_parking`) VALUES 
('Jarville la Malgrange', 'bp@gmail.com','54140','BF451TE','Porcu','Baptiste','982272892872','0699335698','azerty',0),
('Vandoeuvre les Nancy', 'qm@gmail.com','54500','TERF42R','Mathieu','Quentin','28373848738','0689786756','ytreza',0),
('Vandoeuvre les Nancy', 'ad@gmail.com','54500','FERG456T','Dozas','Arthur','983739928384','0767456563','12345',0),
('Vandoeuvre les Nancy', 'ls@gmail.com','54500','PO879TE','Schwing','Lucas','27366474837','0689342167','6789',0)");
...
$resultat=mysqli_query($id, 'CREATE TABLE `parking_type` (
...
$resultat=mysqli_query($id, "INSERT INTO `parking_type` (`nom_parking`, `nombre_de_place`) VALUES
('Indigo Nancy Carnot', 370),
('Parking Gare Nancy', 398),
('Parking Dom Calmet', 196),
('Parking Vaudémont', 190)");
